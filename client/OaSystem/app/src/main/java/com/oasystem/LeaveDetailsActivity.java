...
public class LeaveDetailsActivity extends Activity {
        ...
        public void handleMessage(Message message){
            switch (message.what){
                ...
                case sendToastWhat:
                    ...
                    Toast.makeText(LeaveDetailsActivity.this,toast,Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        leaveTable=(LeaveTable)(getIntent().getSerializableExtra("check"));
        initData();
    }
    ...
    public void manage(final String managerText){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                map.put("leaveid", leaveTable.getId()+"");
                String result=netWork.doPost(map, URLValues.managerURL);
    ...
    private void initData() {
        ...
        name.setText(leaveTable.getUser().getName());
        TextView time=(TextView)findViewById(R.id.time);
        time.setText(leaveTable.getCreateTime());
        TextView content=(TextView)findViewById(R.id.content);
        content.setText(leaveTable.getContent());
